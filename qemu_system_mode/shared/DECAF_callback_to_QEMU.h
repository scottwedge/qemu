...
void helper_DECAF_invoke_mem_read_callback(gva_t virt_addr,gpa_t phy_addr, unsigned long value, DECAF_DATA_TYPE data_type);
#ifdef STORE_PAGE_FUNC
void helper_DECAF_invoke_mem_write_callback(gva_t virt_addr,gva_t phy_addr, unsigned long virt_haddr,unsigned long value, DECAF_DATA_TYPE data_type, int caller_pos);
#else
void helper_DECAF_invoke_mem_write_callback(gva_t virt_addr,gpa_t phy_addr,unsigned long value, DECAF_DATA_TYPE data_type);
#endif
